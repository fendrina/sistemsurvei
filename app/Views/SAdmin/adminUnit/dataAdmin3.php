...
<div class="main-panel">          
  <div class="content-wrapper">
    <div class="card">
      <div class="card-body">
        <p class="card-title">Admin Unit Pelayanan</p>
 ...
 <!-- Modal Add -->
<form action="<?= base_url('SAdmin/DataAdmin3/save'); ?>" method="post" class="needs-validation" novalidate>
...
<form action="<?= base_url('SAdmin/DataAdmin3/edit/'.$a['id'])?>" method="post">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label class="col-sm-4 col-form-label">Username</label>
          <div class="col-sm-8">
            <input type="text" value="<?= $a['username']; ?>" class="form-control" name="username" placeholder="Username">
          </div>
        </div>
...
<div class="modal fade" id="deleteModal<?= $a['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?= base_url('SAdmin/DataAdmin3/delete/'.$a['id']); ?>" type="button" class="btn1 btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
