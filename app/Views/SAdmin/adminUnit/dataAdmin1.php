...
<div class="main-panel">          
  <div class="content-wrapper">
    <div class="card">
      <div class="card-body">
        <p class="card-title">Admin Unit Akademik</p>
 ...
 <!-- Modal Add -->
<form action="<?= base_url('SAdmin/DataAdmin1/save'); ?>" method="post" class="needs-validation" novalidate>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="email" placeholder="co: email@gmail.com" required>
            <div class="invalid-feedback">
...
<!-- Modal Edit -->
<?php $i = 1; foreach($admin as $a) { ?>
<form action="<?= base_url('SAdmin/DataAdmin1/edit/'.$a['id'])?>" method="post">
...
<div class="modal fade" id="deleteModal<?= $a['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?= base_url('SAdmin/DataAdmin1/delete/'.$a['id']); ?>" type="button" class="btn1 btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
