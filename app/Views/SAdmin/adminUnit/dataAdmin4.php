...
<div class="main-panel">          
  <div class="content-wrapper">
    <div class="card">
      <div class="card-body">
        <p class="card-title">Admin Unit Laboratorium</p>
 ...
 <!-- Modal Add -->
<form action="<?= base_url('SAdmin/DataAdmin4/save'); ?>" method="post" class="needs-validation" novalidate>
...
<!-- Modal Edit -->
<?php $i = 1; foreach($admin as $a) { ?>
<form action="<?= base_url('SAdmin/DataAdmin4/edit/'.$a['id'])?>" method="post">
...
<div class="modal fade" id="deleteModal<?= $a['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a href="<?= base_url('SAdmin/DataAdmin4/delete/'.$a['id']); ?>" type="button" class="btn1 btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
